...
const DashboardLayoutAdmin = () => {
    ...
    const drawer = (
        <div>
            <Toolbar />
            <List>
                <ListItem button onClick={() => navigate("/admin")} style={{ cursor: "pointer" }}>
                    <ListItemIcon>
                        <DashboardIcon sx={{ color: "var(--beige-dark)" }} />
                    </ListItemIcon>
                    <ListItemText  primary="Inicio" />
                </ListItem>  
                <ListItem button  onClick={() => navigate("/admin/create-invitation")}  style={{ cursor: "pointer" }}>
                    <ListItemIcon>
                        <AddIcon sx={{ color: "var(--beige-dark)" }} />
                    </ListItemIcon>
                    <ListItemText primary="Crear Invitación" />
                </ListItem>
                <ListItem button  onClick={() => navigate("/admin/setting")} style={{ cursor: "pointer" }}>
                    <ListItemIcon>
